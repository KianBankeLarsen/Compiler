...
\chapter{Conclusion}
In this bachelor project, a compiler has been successfully implemented, which can be used both as a stack machine and a register machine. The compiler consists of a scanner, parser, symbol collector, desugar, code generator, allocator and a code emitter. The compiler consists of approximately 3500 lines of Python code.
...
Every project has a README. In addition to providing a light introduction to the project, a static website has been generated on the file, from which the code is publicly available: \url{https://kianbankelarsen.github.io/Compiler/}
