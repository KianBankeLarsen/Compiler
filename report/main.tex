...
A workflow build consists of the stages stated in Figure \ref{fig:workflow_run}.  Note that the stack machine test passed, but the register version did not (errors are fixed, this is for presentation only).
