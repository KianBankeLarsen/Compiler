...
The test suite is automatically run on every pull request or push to GitHub as part of the CI pipeline/workflow using GitHub Actions. Configuration can be found in \texttt{/.github/workflows/unittest.yml}.
