\begin{tikzpicture}
    \node[anchor=south east] at (0,0) {$2^n$};
    \node[anchor=north east] at (0,5.25) {Low};
    ...
    \draw [decorate, decoration = {calligraphic brace, raise=2pt, amplitude=5pt}] (0,0.75) --++  (0,1.5) node[midway, xshift=-1cm]{Precall};
    \draw [decorate, decoration = {calligraphic brace, raise=2pt, amplitude=5pt}] (0,2.25) --++  (0,0.75) node[midway, xshift=-1cm]{Call};
    \draw [decorate, decoration = {calligraphic brace, raise=2pt, amplitude=5pt}] (0,3) --++  (0,0.75) node[midway, xshift=-1cm]{Prolog};
\end{tikzpicture}